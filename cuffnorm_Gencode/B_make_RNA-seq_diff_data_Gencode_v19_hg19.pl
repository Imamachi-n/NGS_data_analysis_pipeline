...
#REF#################################
open(REF, "</home/akimitsu/custom_command/cuffnorm_Gencode/mRNA_lncRNA_list_gencode_v19_hg19.txt") || die;
...
open(OUT_mRNA,">$input/genes_Gencode_v19_result_mRNA.fpkm_table") || die;
open(OUT_ncRNA,">$input/genes_Gencode_v19_result_ncRNA.fpkm_table") || die;
