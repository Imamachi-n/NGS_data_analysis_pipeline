...
for line in input_file:
    ...
    infe_6h_no = float(data[3])
    infe_6h_wt = float(data[4])
    div_test_6h = '.'
    div_6h = '.'
    if infe_6h_no == 0:
        if infe_6h_wt < 1:
    ...
    infe_18h_no = float(data[5])
    infe_18h_wt = float(data[6])
    div_test_18h = '.'
    div_18h = '.'
    if infe_18h_no == 0:
        if infe_18h_wt < 1:
        ...
        if div_18h >= 2 and infe_18h_wt >= 1:
            div_test_18h = 'infection-sensitive'
    print("\t".join(data[:1]),infe_2h_no,infe_2h_wt,div_2h,div_test_2h,infe_6h_no,infe_6h_wt,div_6h,div_test_6h,infe_18h_no,infe_18h_wt,div_18h,div_test_18h, sep="\t", end="\n", file=output_file)
