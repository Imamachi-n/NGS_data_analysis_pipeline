...
#my @gene_list =("ALDOA","ATP5B","ENO1","PGK1");
...
#REF#############################
open(REF,"<$input\_mRNA_rel.fpkm_table") || die;
...
open(IN,"<$input\_$filename\_rel.fpkm_table") || die;
open(OUT,">$input\_$filename\_rel_normalized.fpkm_table") || die;
