...
bowtie -p 8 --un ${file}_2_norrna.fastq /home/akimitsu/database/bowtie1_index/contam_Ribosomal_RNA ${file}_1_filtered.fastq > ${file}_3_rrna_contam.fastq 2>> ./log_${file}.txt
...
STAR --runThreadN ${threadNum} --genomeDir /home/akimitsu/database/STAR_index/hg38_Gencode_v24_Luc2 \
