...
################################
open(IN,"</home/akimitsu/Refseq_gene_hg19_June_02_2014.gtf") || die;
open(OUT,">/home/akimitsu/custom_command/cuffnorm_RefSeq/mRNA_lncRNA_list_RefSeq_hg19_June_02_2014.txt") || die;
